...
<div class="container">
  ...
  <thead>
    ...
    <tr>
      ...
      <th scope="col"><?php echo $userData['email']; ?></th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
{
  if (!$con->query("insert into useraccounts (name,city,address,email,password) values ('$_POST[name]','$_POST[city]','$_POST[address]','$_POST[email]','$_POST[password]')")) {
    echo "<div claass='alert alert-success'>Failed. Error is:".$con->error."</div>";
  }
  else
    echo "<div class='alert alert-info text-center'>Account Updated Successfully</div>";
